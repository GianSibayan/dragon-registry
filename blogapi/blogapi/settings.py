...
SECRET_KEY = 'django-insecure-+uz70ptf_3)4xep9$h#%pi()um+-0*zs@+379#(ciu34f^_m58'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'dragons' / 'templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Override database with Railway's env variable if it exists
